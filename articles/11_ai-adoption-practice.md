...
作る側としては、品質に手応えがありました。実際に触ってもらえば、価値は伝わるはずだと。

しかし、現実は違いました。使われてはいる。でも修正が多く、満足度は上がりきらない。整備したマニュアルは読まれない。質問も来ない。そして、生成待ちの1時間のあいだに、静かに心が折れていく人がいる。

先に種明かしをすると、定着を止めていたのは、ツールの性能ではありませんでした。壁は1つではなく、性質の違う4種類が重なっていた。そして、壁ごとに打ち手を変えたとき、初めて状況が動き始めました。**ツールは変えていない。変えたのは「使われ方の設計」だけ**——これがこの記事の結論です。

もう1つ、白状しておくと、私たちは伝え方も間違えていました。「AIを使えば速くなります」と案内していたのです。この一言が定着をどれだけ妨げていたかは、後半で書きます。
...
![AIツールが定着しない裏側にある4つの壁。心理の壁・初回体験の壁・習熟の壁・定着の壁の順に、計23の障壁が現れる](../assets/article-images/11_ai-adoption-practice/img_01.png)
...
壁の全体像が見えてから、私たちは打ち手を重ねていきました。あとから振り返ると、やっていたことは3種類の「設計」に整理できます。**場の設計、伝え方の設計、道具の設計**。冒頭で「変えたのは使われ方の設計だけ」と書きましたが、その中身がこの3つです。
...
冒頭で「伝え方を間違えていた」と書いた話を、ここで回収します。
